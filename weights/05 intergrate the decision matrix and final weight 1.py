...
olympic_csv_path = 'E:/02 Cathy/09 math contest/10 math modelling/2024 contest high school/05 ML/Olympic Indicator.csv'
...
# Export to CSV
output_file = folder_path_ML + "logistic_regression_predictions test.csv"
...
print(results_full)
# Export to CSV
output_file_log_full = folder_path_ML + "logistic_full_predictions.csv"
